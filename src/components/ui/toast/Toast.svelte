...
<div
	class={`relative mb-2 flex w-80 cursor-pointer items-start gap-2 rounded-sm border px-4 py-2 shadow-md transition-transform  ${type === 'success' ? 'bg-green-bright border-green-dark' : type === 'cancel' ? 'border-red-dark bg-red' : 'border-blue-950 bg-blue-500'} text-white`}
